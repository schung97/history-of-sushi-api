...
# def update
#   user = User.find(params[:id])
#   user.update(knowledge: params[:knowledge])
#   if user.save
#     params[:suggestions].each do | res |
#       Suggestion.create(user_id: user.id, restaurant_id: res)
#     end
...
#
# def user_params
#   params.require(:user).permit(:firstname, :lastname, :username, :email, :password, :password_confirmation, :joined_on, :knowledge, :avatar, :id, suggestions: [])
# end
